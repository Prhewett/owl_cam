Backgound. 
I built an Owl Box to encourage a family of Owls to move onto our place and hopefully eat some of the rodents that are living in and near the barn.
...
The obvious answer was a camera, but the Owl box is not near power and a long way up a pole - so changing batteries in a trail cam....wasnt an option.
...
The Pi seems to use little enough power that a full charge of the 90 AH battery keeps it running all night, while taking still every 30 minutes and making a time lapse MP4, and then it pushes the images and some basic html to an EC2 server. 
